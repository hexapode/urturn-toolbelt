module.exports = function(grunt) {
  ...
  config.removelogging = {
    editor_script: {
      src: tmpdir.path + "/build/editor.js",
      dest: tmpdir.path + "/build/editor_clean.js"
    },
    player_script: {
      src: tmpdir.path + "/build/player.js",
      dest: tmpdir.path + "/build/player_clean.js"
    }
  };
  ...
  config.min = {
    editor_script: {
      src: tmpdir.path + "/build/editor_clean.js",
      dest: tmpdir.path + "/dist/editor.min.js"
    },
    player_script: {
      src: tmpdir.path + "/build/player_clean.js",
  ...
  grunt.registerTask('default', ['copyAll', 'rebindCssUrl', "exportCSSImportStatement", 'concat', 'removelogging', 'min', 'mincss', 'updateDescriptor', 'compressDist']);
  grunt.registerTask('debug', ['copyAll', 'compressDist']);
}